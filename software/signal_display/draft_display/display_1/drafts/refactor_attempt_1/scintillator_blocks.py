...
class ScintillatorStructure:
    def __init__(self, num_doubles, square_side_len, width_per_one, dead_space, in_between_space):

        self.setup_structure(
                        num_doubles      =               num_doubles, # 3 each
                        square_side_len  =               square_side_len, # mm
                        width_per_one    =               width_per_one, # mm
                        dead_space       =               dead_space, # mm
                        in_between_space =               in_between_space, # mm
                        x_i              =               0,
                        y_i              =               0,
                        z_i              =               0,
                        c1               = [1, 0.75, 0.75],
