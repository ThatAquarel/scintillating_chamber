...
class Plane:
    def __init__(self, scale=1.0):
        ...
        self.data = np.ones((len(self.vertices), 9), dtype=np.float32)
        ...
        #     if i %2 ==  0 :
        #         self.data[i*36:(i+1)*36,3:6] = [1,1,1]
        #     else:
        #         self.data[i*36:(i+1)*36,3:6] = [211/256,211/256,211/256]


        #Set normals
        self.data[:, 6:9] = self.vertices  
    ...
    def generate_plane_vertices(self,size):
        ...
        for layer in range(2,18):
            ...
            z1 = layer * size * -0.1 + 0.4      #z
            z2 = (layer + 1) * size * -0.1  + 0.4        #-z
